...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 200 //cottlestone
   ...
   */
  #define BLTOUCH_HS_MODE true //cottlestone
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA //cottlestone
  ...
  #define UTF_FILENAME_SUPPORT //cottlestone

  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //cottlestone
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu //cottlestone
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //cottlestone
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //cottlestone
 ...
 */
#define BABYSTEPPING //cottlestone
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING //cottlestone
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). //cottlestone
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //cottlestone
 ...
 */
#define EMERGENCY_PARSER //cottlestone
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) //cottlestone
   ...
   */
  #define HYBRID_THRESHOLD //cottlestone

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD       20 //cottlestone
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  72 //cottlestone
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70 //cottlestone
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  10 //cottlestone
    ...
    #define IMPROVE_HOMING_RELIABILITY //cottlestone
  #endif
 ...
 */
#define AUTO_REPORT_POSITION //cottlestone
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations //cottlestone
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) //cottlestone
...
//#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76 //cottlestone
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback //cottlestone
